...
describe("/api/categories", () => {
  ...
  describe("GET /", () => {
    it("should return all categories", async () => {
      const categories = [{ name: "genre1" }, { name: "genre2" }];
  ...
  describe("PUT /:id", () => {
    ...
    beforeEach(async () => {
      ...
      category = new Category({ name: "genre1" });
      await category.save();
    ...
    it("should update the category if input is valid", async () => {
      ...
      const updatedGenre = await Category.findById(category._id);
  ...
  describe("DELETE /:id", () => {
    ...
    it("should delete the category if input is valid", async () => {
      ...
      const genreInDb = await Category.findById(id);
